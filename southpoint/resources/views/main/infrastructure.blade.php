                ...
                <div class="six-columns six-offset">
                    <div class="content-left-margin-40">
                        <h2 class="large-title-bold">
                            <span class="load-title-fill tr-delay03" data-text="South Point">South Point</span><br>
                            <span class="load-title-fill tr-delay04" data-text="Training">Training</span><br>
                            <span class="load-title-fill tr-delay05"
                                  data-text="& Selection Centre">& Selection Centre</span>
                        </h2>
                    ...
                    <div class="swiper-slide">
                        ...
                        <a href="{{ asset('storage/'.$image->image) }}" class="swiper-slide photo-popup pointer-zoom">
                            ...
                            <div class="portfolio-slider2-content">
                                <span
                                    class="small-title-oswald red-color portfolio-slider-overlay">{{ $image->title }}</span>
                                <h2 class="title-style text-color-4">
										<span class="hidden-box d-block text-height-10">
											<span
                                                class="portfolio-slider-fade portfolio-slider-tr-03">{{ $image->content }}</span>
										</span>
                                </h2>
                            </div>
                        </a><!-- inner slide end -->
