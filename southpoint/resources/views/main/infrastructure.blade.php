                    ...
                    <div class="swiper-slide">
                        ...
                        <a href="{{ asset('storage/'.$image->image) }}" class="swiper-slide photo-popup pointer-zoom">
                            ...
                            <div class="portfolio-slider2-content">
                                <span
                                    class="small-title-oswald portfolio-slider-overlay" style="color : white; background: rgb(255,0,0,0.6); padding: 5px">{{ $image->title }}</span>
                                <h2 class="title-style text-color-4">
										<span class="hidden-box d-block text-height-10">
											<span
                                                class="portfolio-slider-fade portfolio-slider-tr-03" style="color : white; background: 	rgb(255,0,0,0.6); padding : 10px">{{ $image->content }}</span>
										</span>
                                </h2>
                            </div>
                        </a><!-- inner slide end -->
